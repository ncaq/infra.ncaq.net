...
# 無料版のCloudflare Zeno Trust Tunnelのhttpsでの一回での通信では転送量制限が厳しいのでsshに逃げられるようにしています。
# 無料版のCloudflare Zeno Trust Tunnelの制約上`ssh.forgejo.ncaq.net`とするとTLSの解決ができないため、
